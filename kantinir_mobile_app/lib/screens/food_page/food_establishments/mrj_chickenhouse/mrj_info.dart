...
class mrJChickenHouseCoffeeInfoPage extends StatefulWidget {
  ...
  @override
  State<mrJChickenHouseCoffeeInfoPage> createState() => _mrJChickenHouseCoffeeInfoPageState();
}

class _mrJChickenHouseCoffeeInfoPageState extends State<mrJChickenHouseCoffeeInfoPage> {
  Future<double?> _fetchRating() async {
    final snapshot = await FirebaseFirestore.instance.collection('kaon').doc('5').get();
    if (snapshot.exists) {
