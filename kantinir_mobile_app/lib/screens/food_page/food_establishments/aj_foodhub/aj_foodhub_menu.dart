...
class ajFoodHubMenuPage extends StatefulWidget {
  const ajFoodHubMenuPage({Key? key}) : super(key: key);

  @override
  State<ajFoodHubMenuPage> createState() => _ajFoodHubMenuPageState();
}

class _ajFoodHubMenuPageState extends State<ajFoodHubMenuPage> {
  late List<Food> data = [];
  ...
  child: Container(
    ...
    decoration: BoxDecoration(
      ...
      image: DecorationImage(
        image: AssetImage('images/aj_foodhub_items/${item.image_path}.jpg'),
        fit: BoxFit.cover,
      ),
    ),
    child: Center(
