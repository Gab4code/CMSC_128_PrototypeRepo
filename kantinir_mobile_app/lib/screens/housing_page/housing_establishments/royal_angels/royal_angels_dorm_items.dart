...
class royalAngelsItemPage extends StatefulWidget {
  const royalAngelsItemPage({Key? key}) : super(key: key);

  @override
  State<royalAngelsItemPage> createState() => _royalAngelsItemPageState();
}

class _royalAngelsItemPageState extends State<royalAngelsItemPage> {
  ...
  // Extract food items from snapshot
   snapshot.docs.forEach((doc) {
     facilities.add(House(name: doc['name'], category: doc['category'], image_path: doc['image_path']));
  });
  ...
  child: Container(
    ...
    decoration: BoxDecoration(
      ...
      image: DecorationImage(
        image: AssetImage('images/royal_angels_items/${item.image_path}.jpg'),
        fit: BoxFit.cover,
      ),
    ),
    child: Center(
