...
class arkidsDormItemPage extends StatefulWidget {
  const arkidsDormItemPage({Key? key}) : super(key: key);

  @override
  State<arkidsDormItemPage> createState() => _arkidsDormItemPageState();
}

class _arkidsDormItemPageState extends State<arkidsDormItemPage> {
  ...
  child: Container(
    ...
    decoration: BoxDecoration(
      ...
      image: DecorationImage(
        image: AssetImage('images/arkids_items/${item.image_path}.jpg'),
        fit: BoxFit.cover,
      ),
    ),
    child: Center(
