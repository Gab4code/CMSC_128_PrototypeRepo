...
class kpVisionItemPage extends StatefulWidget {
  const kpVisionItemPage({Key? key}) : super(key: key);

  @override
  State<kpVisionItemPage> createState() => _kpVisionItemPageState();
}

class _kpVisionItemPageState extends State<kpVisionItemPage> {
  ...
  child: Container(
    ...
    decoration: BoxDecoration(
      ...
      image: DecorationImage(
        image: AssetImage('images/kp_vision_items/${item.image_path}.jpg'),
        fit: BoxFit.cover,
      ),
    ),
    child: Center(
